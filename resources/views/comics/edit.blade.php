        ...
        <div class="col-8">
            <form action="{{ route('comics.update', $comic) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="artists" class="form-control" id="artists" value="{{ $comic->artists }}">
                </div>
                <div class="mb-3">
                    <label for="writers" class="form-label">Scrittori </label>
                    <input type="text" name="writers" class="form-control" id="writers" value="{{ $comic->writers }}">
                </div>
